...
return [
    ...
    */
    'bots' => [
        'tlg_trello_bot' => [
            'token' => env('TELEGRAM_TRELLO_BOT_TOKEN'),
            'webhook_url' => env('TELEGRAM_TRELLO_WEBHOOK_URL'),
            'async_requests' => true,
            /*
            ...
            'commands' => [
                \App\Console\Commands\Telegram\Trello\StartCommand::class,
                \App\Console\Commands\Telegram\Trello\StopCommand::class,
            ],
        ],
